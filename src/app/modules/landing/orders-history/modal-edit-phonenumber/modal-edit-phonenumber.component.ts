...
@Component({
  selector: 'app-modal-edit-phonenumber-address',
  templateUrl: './modal-edit-phonenumber.component.html',
  styles       : [
        `
            /** Custom input number **/
...
export class EditPhoneNumberDialog implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<EditPhoneNumberDialog>,
    ...
    ngOnInit(): void {
        ...
        this.addressForm.get('phoneNumber').patchValue(this.phoneNumber);
