...
import { StoreAssets, Store } from 'app/core/store/store.types';
import { Product } from 'app/core/product/product.types';
import { FuseMediaWatcherService } from '@fuse/services/media-watcher';
import { FamousItem } from 'app/core/location/location.types';
import { ProductsService } from 'app/core/product/product.service';
import { StoresService } from 'app/core/store/store.service';

@Component({
    selector     : 'famous-products',
    templateUrl  : './famous-products.component.html',
    encapsulation: ViewEncapsulation.None
})
export class _FamousProductsComponent implements OnInit, OnDestroy
{
    ...
    redirectToProduct(productDetails: FamousItem) {
